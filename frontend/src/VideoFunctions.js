...
//     document.querySelector(".raise-hand-button").innerText = `${localParticipant.handRaised ? "lower your hand" : "raise your hand"
//         }`;
//     document.querySelector(".hand-state").innerText = `${localParticipant.handRaised ? "your hand is up" : "your hand is down"
//         }`;
// }
...
//     let room = { url: "https://popschools.daily.co/qOrbXQ3zJZC7o7aH8ycI" };
//     // 
//     // "https://therapize.daily.co/Therapize"
